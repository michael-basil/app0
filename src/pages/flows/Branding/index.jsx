...
export default function FlowBranding() {
  return (
    <FlowPage
      slug="branding"
      sections={{
        intent: "Present a fully branded Universal Login experience — complete with logo, color palette, and background — to create a seamless identity experience for customers.",
        experience: [
