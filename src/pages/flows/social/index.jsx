  ...
  if (event.connection?.strategy === "auth0") {
    ...
    api.multifactor.enable("any");
        ...
        links: [
          ...
          { text: "Dashboard — Forms",                                  href: "https://forms.auth0.com/tenants/#/forms" },
          { text: "Dashboard — Flows",                                  href: "https://forms.auth0.com/tenants/#/flows" },
          { text: "Dashboard — Vault",                                  href: "https://forms.auth0.com/tenants/#/vault" },
